...
def get_current_articles_on_ministry_of_finance():
    url_ministry_of_finance_list =['https://www.gov.pl/web/finanse/ostrzezenia-i-wyjasnienia-podatkowe','https://www.gov.pl/web/finanse/ostrzezenia-i-wyjasnienia-podatkowe?page=2']
